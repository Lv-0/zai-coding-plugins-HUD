...
Fetches fresh data and writes to cache.
"""

from .core import try_zai_plugin_query, try_original_analysis, direct_data_analysis, calculate_reset_time
from .cache import write_cache


def main():
    usage_data = try_zai_plugin_query()
    if not usage_data:
